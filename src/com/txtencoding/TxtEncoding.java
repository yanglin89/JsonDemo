...
public class TxtEncoding {
	...
	public static String getFileEncode(String path) {
	    String charset ="GBK";//此处的GBK是国内使用的，原为ASCI
	...
	public static void main(String[] args) {
		String path = "C:/Users/yangl/Desktop/编码格式.txt";
//		String path = "C:/Users/yangl/Desktop/需查询技术.txt";
		
		String a = getFileEncode(path);
		String content = null ;
		try {
//			content = FileUtils.readTxt(path, a);
			content = FileUtil.readTxt(path, a);
		} catch (Exception e) {
